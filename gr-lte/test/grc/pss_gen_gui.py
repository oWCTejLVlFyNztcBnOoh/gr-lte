...
# Title: Pss Gen Gui
# Generated: Tue Oct 23 20:00:23 2012
##################################################

execfile("/home/user/.grc_gnuradio/lte_dl_ss_source.py")
...
class pss_gen_gui(grc_wxgui.top_block_gui):

	def __init__(self, N_cp_ts=144, freq_corr=0, N_re=128):
		grc_wxgui.top_block_gui.__init__(self, title="Pss Gen Gui")
		...
		self.lte_dl_ss_source_0 = lte_dl_ss_source(
			decim=16,
			N_id_1=134,
			N_id_2=0,
		)
		...
		self.connect((self.lte_dl_ss_source_0, 0), (self.gr_throttle_0, 0))
...
if __name__ == '__main__':
	...
	tb = pss_gen_gui(N_cp_ts=options.N_cp_ts, freq_corr=options.freq_corr, N_re=options.N_re)
	tb.Run(True)
